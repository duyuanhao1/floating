...
layout_section=[addresslineform(1:Nt)-0.2*gridlength,addresslineform(Nt+1:2*Nt)-0.2*gridlength;addresslineform(1:Nt)+0.2*gridlength,addresslineform(Nt+1:2*Nt)+0.2*gridwidth];
